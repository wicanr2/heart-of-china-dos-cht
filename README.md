...
而這封信的第一張照片，我想留給開機那一眼 —— 銅色的古地圖、放射狀的太陽、英文那行
青綠金屬光澤的 "HEART OF CHINA"。當年那個孩子盯著它，連片名都讀不順。現在，同一張
標題畫面，金筆「中國之心」端端正正落在英文片名下緣，描金的筆鋒呼應著上頭那行字的
描邊。三十年了，他終於在開機第一眼，就看懂了這款遊戲叫什麼名字：

![開機標題・中國之心](screenshots/showcase_zh_title.png)

> **開機第一眼。** 1930 年代的古銅羊皮地圖上，英文片名底下那行金色毛筆楷書「中國之心」，
> 是這次親手焊進三十年前標題藝術字裡的。當年讀不懂片名的孩子，如今一開機就看見它。
...
開機標題你已經在上面那封信裡看過了 —— 那是門面。但門面之後，這款遊戲是一句一句台詞
撐起來的。下面所有截圖都是**引擎內建 autopilot 自動跑出來的**，不是 PS 合成 —— 真
**24×24 點陣字**直接畫在 1991 年的遊戲畫面上，名牌、對白、思考泡泡全中文化。
...
Dragon》（軟體世界當年譯作《城市獵人》）同一位設計師、同一套 DGDS 引擎。但先講一件這款遊戲
真正特別的事：**它是世界上第一款以民初為背景的電腦遊戲**。華人做民初題材不稀奇，稀奇的是
**連洋人都做了** —— 而且搶在所有人前頭。1930 年代的軍閥、鴉片館、東方快車，在當年美國開發者
眼裡是一塊夠異國、夠值得當賣點的東方想像；於是有了這款由一群美國人做的、講中國的冒險遊戲。
名字叫《中國之心》，可大半劇情根本不在中國 —— 但這個「名實不符」本身，反倒坐實了「民初中國」
在洋人心中那份東方異國濾鏡有多濃。

回到 1991 年的軟體世界中文版說明書，故事大綱是這樣開頭的：
...
三十年後，聯合報的【電玩說書人】專欄（作者「宅編」）回頭盤點這款「世界第一民初遊戲」，
把它的多重結局、各種死法、火車頂比劍、開軍閥坦克突圍一樣一樣數了一遍 —— 然後在全文最後，
留下一句很重的話：

> 「最後得告訴大家一個壞消息：**沒有中文版**。」
> ——聯合報【電玩說書人】〈世界上第一款民初遊戲：中國之心〉

他說沒有中文版。**現在有了。** 這個 repo，就是那句話遲到三十年的回答 —— 全劇本 4,651 句，
從第一句到最後一句，都是看得懂的中文。故事講完了，但這趟旅程真正的重量，在三個跟你綁在
一起的人身上。
...
有意思的是，這份考古判斷在三十年後得到了佐證。聯合報【電玩說書人】專欄回看這款遊戲時，也忍不住
吐槽過兩處：擄走凱蒂的成都軍閥，「不知叫李甚麼還是鄧甚麼，反正中國軍人都是軍閥」；而在香港接應
主角的中國人，竟是個**忍者**（NINJA）—— 不是黑衣人、不是刺客，就是貨真價實的日本忍者。這正是
那個年代西方東方學的經典誤讀：洋人開發者把整片東亞糊成一團，軍閥誰是誰無所謂、中國人配個忍者
也理所當然。而我們替這位忍者定名**齊豪**、替軍閥定名**鄧利**（姓鄧名利），靠的恰恰就是當年那本
軟體世界說明書 —— 譯者在「反正都是軍閥」的英文原文裡，硬是給了他一個有名有姓的中文身分。專欄家
看到的是誤讀的趣味，我們承接的是那本說明書替誤讀補上的尊嚴。同一處誤讀，兩種讀法，互相印證。
...
### 4. 標題畫面：金筆「中國之心」overlay

attract 標題 `TITLE.SCR` 走的不是上面三條繪字路徑，而是 `present2x` 全螢幕點陣 latch，沒有可攔的
`drawString` 呼叫。因此中文片名以**疊圖遮罩**方式注入，與對白/名牌的繪字 hook 互相獨立：

- **Latch 點**：hook `TITLE.SCR` 的 `present2x`，在背景圖（古地圖銅色帶 + 英文 "HEART OF CHINA"
  藝術字）latch 上螢幕的當拍寫入 overlay。
- **偵測英文相**：attract 序列含多拍（淡入 / 純背景 / 英文片名 / 遊戲原生毛筆中國之心）。overlay
  只在**英文片名已現、原生毛筆字尚未進場**的那一拍貼上金筆楷書，避免雙重中文字疊字。
- **UKai 楷書遮罩**：`tools/build_title_mask.py` 以 AR PL UKai 楷書 rasterize「中國之心」四字 →
  放大 → 描深邊 → 置中於英文片名下緣的銅色帶，輸出點陣遮罩編進引擎（金字色取自原標題描金線）。
- **不覆蓋原生毛筆字**：偵測到原生毛筆「中國之心」進場的後續拍即停止貼 overlay，原作的標題動畫
  完整保留，僅在英文那一拍補上金筆楷書（`screenshots/showcase_zh_title.png`）。
...
- **骨灰集散地「說明書補完計劃」**（文字編輯 賴旭輝、美工編輯 李孟花）—— 掃描還原了那本
  油墨早乾的說明書，這份譯名考古才有依據。
- **聯合報【電玩說書人】專欄（作者「宅編」）** —— 〈世界上第一款民初遊戲：中國之心〉一文
  替這款冷門老遊戲留下了中文媒體的紀錄，點出它「世界第一民初遊戲」的歷史地位，也是文末那句
  「沒有中文版」促成這份遲到三十年回答的源頭。
