...
> 「洋基之鷹」號機艙內 —— 來福剛把凱蒂救出來，正準備飛往香港。全程繁體中文、真 **24×24 點陣字**，
> 名牌、對白、思考泡泡都中文化。角色採 **1990s 軟體世界中文版說明書的官方譯名**（來福 / 齊豪 / 凱蒂，
> 見〈[譯名考古](#譯名考古為什麼主角叫來福忍者叫齊豪)〉）。以下截圖都是**引擎內建 autopilot 自動跑出來的**。
...
| 齊豪：「你不懂。西方醫院治不了這種蛇毒。」| 來福心想：「唉喲！女人啊！」（thought-bubble 框型）|
...
| `CHI: Lucky, we can't leave without Nurse Kate!` | `齊豪：來福，我們不能丟下凱蒂護士不管！` |
...
寫著看不懂的字的城寨，在腦子裡替來福和齊豪配上一整套自己編的中文台詞。卡住了就翻
...
- **時間是 1930 年代，舞台橫跨半個地球。** 你是 Jake「Lucky」Masters（**來福**），
  ...
  成都，從軍閥 **鄧利**（Li Deng）的城寨裡救出他女兒 **凱蒂**（Kate）。你拉上了中國忍者 **齊豪**（Zhao Chi）
...
> **中國忍者齊豪**(Zhao Chi)來幫助來福。」——《軟體世界》中文版說明書．故事大綱

**來福**（Lucky）、**齊豪**（那位有名有姓的中國忍者）、軍閥**鄧利**（Li Deng）、報業富賈
