...
- **時間是 1930 年代，舞台橫跨半個地球。** 你是 Jake「Lucky」Masters（**來福**），
  一個落魄、嗜賭、開著一架叫「洋基之鷹」破飛機的美國冒險家。報業富賈 **羅麥士**（E.A. Lomax）雇你去
  成都，從軍閥 **鄧立**（Li Deng）的城寨裡救出他女兒 **凱特**（Kate）。你拉上了中國忍者 **賽奇**（Zhao Chi）
...
**來福**（Lucky）、**賽奇**（那位有名有姓的中國忍者）、軍閥**鄧立**（Li Deng）、報業富賈
**羅麥士**（Lomax）——這些不是我們新譯的，是**三十年前那本說明書就定好的名字**。
