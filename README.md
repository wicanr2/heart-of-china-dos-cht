...
![PoC 中文對白](screenshots/poc_zh_d12_1.png)

> 「洋基之鷹」號機艙內，趙奇對老馬說話 —— 名牌「趙奇」+ 內文全程繁體中文、真 24×24 點陣字。
> 這張是**引擎內建 autopilot 自動跑出來的**：引擎照腳本跳場景、強制觸發指定 `(DDS檔,對白號)`、
> 截圖存檔，用來逐句檢查中文排版。

**同一句台詞，F8 切換 英文（原始）↔ 中文：**
...
**全劇本 4,651 句已翻完**（民初冒險通俗派語氣）：

![showcase 老馬](screenshots/showcase_zh_lucky.png)

> 老馬剛把凱特救上「洋基之鷹」號：「太好了！任務完成！香港，我們來啦！銀子，我們來啦！」
